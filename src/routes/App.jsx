  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route exact path="/mobile-product-detail" element={<ItemDetailMobile />} />
        <Route exact path="/mobile-categories" element={<MobileCategoriesPage/>} />
        <Route exact path="/mobile-check-out" element={<MobileCheckOutPage />} />
        <Route exact path="/edit-my-account" element={<EditAccountPage />} />
        <Route exact path="/create-my-account" element={<CreateAccountPage />} />
        <Route exact path="/recovery-password" element={<PasswordRecoveryPage />} />
